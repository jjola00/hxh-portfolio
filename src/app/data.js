export const projectsData = [
  {
    id: 1,
    name: "GetShorts",
    description: "A platform to download short videos from the internet",
    date: "2024-08-1",
  ...
  {
    id: 4,
    name: "Automation for Real State", 
    description: "Transcribe property data into a Word document.",
    date: "2023-11-1",
    demoLink: "https://github.com/slocksert/tayrbot",
  },
  {
    id: 5,
    name: "CyberSecurity Insights - Extension Project",
